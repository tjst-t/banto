...
import { sendRealAnswer } from "@/lib/backend/adapter";
      ...
      {isPending ? (
        <ElicitationFormView
          ...
          onAnswered={async (answer) => {
            ...
            // 台本のThreadでは何も起きず、従来どおりaddResultだけで完結する。
            await sendRealAnswer(props.toolCallId, answer);
            props.addResult?.(answer);
          }}
        />
      ) : (
